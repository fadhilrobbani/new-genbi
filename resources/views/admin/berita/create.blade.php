                ...
                <section class="content">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="inputDescription" class="form-control" name="deskripsi_berita" rows="4"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputStatus">Tingkat Berita</label>
                                        <select id="inputStatus" name="level_id" class="form-control custom-select">
                                            <option selected disabled>Tingkat Berita</option>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button type="submit" value="Tambah Berita" class="btn btn-success float-right">Tambah
                                Berita</button>
                        </div>
                    </div>
                </section>
...
<script>
    $(function() {
        $('input[name="tgl_berita"]').daterangepicker(
        );
        // console.log('true')
    });
</script>
